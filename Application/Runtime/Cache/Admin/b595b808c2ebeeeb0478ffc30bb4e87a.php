...
<script type="text/javascript" src="/app/Public/admin/jquery.min.js"></script>
<script type="text/javascript" src="/app/Public/admin/global.js"></script>
</head>
<body>
...
<div id="dcLeft"><div id="menu">
 ...
 <div id="dcMain"> <!-- 当前位置 -->
<div id="urHere">后台管理中心</div>  <div id="index" class="mainBox" style="padding-top:18px;height:auto!important;height:550px;min-height:550px;">
