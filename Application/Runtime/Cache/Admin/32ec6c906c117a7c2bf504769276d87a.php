...
<TITLE>登录页面</TITLE> 
<SCRIPT src="/app/Public/login/js/jquery-1.9.1.min.js" type="text/javascript"></SCRIPT>
...
.u_logo{
	background: url("/app/Public/login/images/username.png") no-repeat;
	padding: 10px 10px;
	position: absolute;
	top: 43px;
	left: 40px;
...
.p_logo{
	background: url("/app/Public/login/images/password.png") no-repeat;
	padding: 10px 10px;
	position: absolute;
	top: 12px;
	left: 40px;
...
.tou{
	background: url("/app/Public/login/images/tou.png") no-repeat;
	width: 97px;
	height: 92px;
	position: absolute;
	top: -87px;
...
.left_hand{
	background: url("/app/Public/login/images/left_hand.png") no-repeat;
	width: 32px;
	height: 37px;
	position: absolute;
	top: -38px;
...
.right_hand{
	background: url("/app/Public/login/images/right_hand.png") no-repeat;
	width: 32px;
	height: 37px;
	position: absolute;
	top: -38px;
...
.initial_left_hand{
	background: url("/app/Public/login/images/hand.png") no-repeat;
	width: 30px;
	height: 20px;
	position: absolute;
	top: -12px;
...
.left_handing{
	background: url("/app/Public/login/images/left-handing.png") no-repeat;
	width: 30px;
	height: 20px;
	position: absolute;
	top: -24px;
...
.right_handinging{
	background: url("/app/Public/login/images/right_handing.png") no-repeat;
	width: 30px;
	height: 20px;
	position: absolute;
	top: -21px;
